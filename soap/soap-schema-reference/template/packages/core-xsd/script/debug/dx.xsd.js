...
(function (Innovasys) {
    ...
    (function (Content) {
        var Features;
        (function (Features) {
            var DxXsdDocumentFeatureFactory = (function () {
            ...
            var DxXsdDocumentFeature = (function (_super) {
                __extends(DxXsdDocumentFeature, _super);
                function DxXsdDocumentFeature(documentInstance) {
                    _super.call(this, documentInstance);
                }
                    ...
                    if (configuration.profileName == "mobile" || configuration.profileName == "tablet") {
                        switch (configuration.profileName) {
                            ...
                            case "mobile":
                                ...
                                var attributesTable = $("#i-attributes-section-content table.i-filtered-item-list");
                                if (attributesTable.length) {
                                    if (attributesTable.find('tr:first-child').children().length > 2) {
                                        configuration.tablesToPivot.push(new Content.ResponsiveTable(attributesTable.selector, function (originalTable, pivotDiv) {
